					...
					<Mobile>
							<Dropdown item trigger={dropdownTriggerElement} icon={null}>
									<Dropdown.Menu button='true' item='true'>
											...
											<Dropdown.Item onClick={() => history.push('/about')}> {translate('mainItems.about')} </Dropdown.Item>
											<Dropdown.Item onClick={() => history.push('/menu')}> {translate('mainItems.menu')} </Dropdown.Item>
