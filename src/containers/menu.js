    ...
    render() {
        return (<div className='kind-of-black food-menu'>
                ...
                <div className="subcategory">
                    ...
                    <div className="item">
                        <div className="title"> <h3>מרק היום</h3> </div>
                        <div className="titledescription">
                            <h3>שאל את המלצר/ית</h3>
                            <div className="price">33₪</div>
                        </div>
                    </div>
                    <div className="item">
                        <div className="title"> <h3>פטה כבד</h3> </div>
                        <div className="titledescription">
                            <h3>קרם פטה כבד בליווי ריבה ביתית וטוסטונים</h3>
                            <div className="price">48₪</div>
                        </div>
                    </div>

                    <div className="item">
                        <div className="title"> <h3>פטריות ממולאות</h3> </div>
                        <div className="titledescription">
                            <h3>בתערובת של גבינות ועשבי תיבול מטוגנות בשמן עמוק ומצופות בפירורי לחם, על מצע רוטב פסטו</h3>
                ...
                <div className="subcategory">
                    ...
                    <div className="item">
                        ...
                        <div className="titledescription">
                            <h3>דואט דג ואננס ברזילאי בקרם קוקוס פיקנטי, מלווה באורז לבן כמיטב המסורת הברזילאית (אפשרות למוקקה טבעונית – חצילים במקום דג)</h3>
                    ...
                    <div className="item">
                        ...
                        <div className="titledescription">
                            <h3>תבשיל ברזילאי (מעט פיקנטי) עם מיקס פירות-ים, נתחי עוף, דג לבן, עגבניות, קרם קוקוס, ואורז לבן</h3>
                            <div className="price">79₪</div>
                        </div>
                    </div>
                ...
                <div className="subcategory">
                    ...
                    <div className="item">
                        ...
                        <div className="titledescription">
                            <h3>במרינדת תפוזים וצ'ילי מתוק, צרוב בגריל מוגש בתוספת עליי בייבי ותפוחי אדמה אפויים ברוזמרין</h3>
                ...
                <div className="subcategory">
                    ...
                    <div className="item">
                        ...
                        <div className="titledescription">
                            <h3>קוביות חצילים, קוביות עגבנייה, שום, פטרוזיליה, גבינה בולגרית, על בסיס רוטב עגבניות עשיר (אפשרות למנה טבעונית – על בסיס חלב קוקוס במקום שמנת)</h3>
                            <div className="price">45₪</div>
                        </div>
                    </div>
                ...
                <div className="subcategory">
                    ...
                    <div className="item">
                        ...
                        <div className="titledescription">
                            <h3>על מצע של בראוניס ,קרם ריבת חלב ,מעליו קרם קפה עדין בשילוב חוטי מייפל , בציפוי של גנאש אספרסו. (מכיל פקאן סיני)</h3>
                            <div className="price">38₪</div>
                        </div>
                    </div>
                    ...
                    <div className="item">
                        ...
                        <div className="titledescription">
                            <h3>עוגת גבינה אפויה על מצע של עוגיות חמאה במעטפת של גנאש קפה עדין מעוטר בשכבה קריספית של פקאן סיני</h3>
                            <div className="price">38₪</div>
                        </div>
                    </div>
